...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ZObjectPayBank :  IEquatable<ZObjectPayBank>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ZObjectPayBank" /> class.
        /// </summary>
        /// <param name="Id">.</param>
        /// <param name="FieldsToNull">.</param>
        //ÅöÅ@public ZObjectPayBank(string AccountId = null, string BankName = null, string Type = null, string BankCode = null, int PaymentRetryWindow = 0, bool? UseDefaultRetryRule = null, string BankTransferType = null, string BankTransferAccountNumber = null, string type = null)
        public ZObjectPayBank(string AccountId = null, string BankName = null, string Type = null, string BankCode = null, int PaymentRetryWindow = 0, bool? UseDefaultRetryRule = null, string BankTransferType = null, string BankTransferAccountNumber = null, string PaymentMethodStatus = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ZObjectPayBank {\n");            
            //sb.Append("  Objects: [\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ZObjectPayBank);
        }

        /// <summary>
        /// Returns true if ZObjectPayBank instances are equal
        /// </summary>
        /// <param name="other">Instance of ZObjectPayBank to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ZObjectPayBank other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
