...
namespace IO.Swagger.Model
{
    ...
    public partial class Subscription :  IEquatable<Subscription>, IValidatableObject
    {
        ...
        public Subscription(string AccountId = null, string AncestorAccountId = null, bool? AutoRenew = null, DateTime? CancelledDate = null, DateTime? ContractAcceptanceDate = null, DateTime? ContractEffectiveDate = null, string CreatedById = null, DateTime? CreatedDate = null, string CreatorAccountId = null, string CreatorInvoiceOwnerId = null, int? CurrentTerm = null, string CurrentTermPeriodType = null, int? InitialTerm = null, string InitialTermPeriodType = null, string InvoiceOwnerId = null, bool? IsInvoiceSeparate = null, string Name = null, string Notes = null, DateTime? OpportunityCloseDateQT = null, string OpportunityNameQT = null, DateTime? OriginalCreatedDate = null, string OriginalId = null, string PreviousSubscriptionId = null, string QuoteBusinessTypeQT = null, string QuoteNumberQT = null, string QuoteTypeQT = null, string RenewalSetting = null, int? RenewalTerm = null, string RenewalTermPeriodType = null, DateTime? ServiceActivationDate = null, string Status = null, DateTime? SubscriptionEndDate = null, DateTime? SubscriptionStartDate = null, DateTime? TermEndDate = null, DateTime? TermStartDate = null, string TermType = null, string UpdatedById = null, DateTime? UpdatedDate = null, int? Version = null, string ProcessStatus__c = null, string OrderNumber__c = null, string OrderDetailsNumber__c = null, DateTime? ServiceStartDate__cc = null, string ServiceStartDate__c = null, string ERPQuoteNumber__c = null, string ERPQuoteDetailsNumber__c = null)
        {
            ...
            this.ProcessStatus__c = ProcessStatus__c; //カスタム項目
            this.OrderNumber__c = OrderNumber__c; //カスタム項目
            this.OrderDetailsNumber__c = OrderDetailsNumber__c; //カスタム項目
            this.ServiceStartDate__cc = ServiceStartDate__cc; //カスタム項目
            this.ServiceStartDate__c = ServiceStartDate__c; //カスタム項目
            this.ERPQuoteNumber__c = ERPQuoteNumber__c; //カスタム項目
            this.ERPQuoteDetailsNumber__c = ERPQuoteDetailsNumber__c; //カスタム項目
        }
        ...
        //カスタム項目
        [DataMember(Name = "ProcessStatus__c", EmitDefaultValue = false)]
        public string ProcessStatus__c { get; set; }
        //カスタム項目
        [DataMember(Name = "OrderNumber__c", EmitDefaultValue = false)]
        public string OrderNumber__c { get; set; }
        //カスタム項目
        [DataMember(Name = "OrderDetailsNumber__c", EmitDefaultValue = false)]
        public string OrderDetailsNumber__c { get; set; }
        //カスタム項目
        [DataMember(Name = "ServiceStartDate__cc", EmitDefaultValue = false)]
        public DateTime? ServiceStartDate__cc { get; set; }
        //カスタム項目
        [DataMember(Name = "ServiceStartDate__c", EmitDefaultValue = false)]
        public string ServiceStartDate__c { get; set; }
        [DataMember(Name = "ERPQuoteNumber__c", EmitDefaultValue = false)]
        public string ERPQuoteNumber__c { get; set; }
        [DataMember(Name = "ERPQuoteDetailsNumber__c", EmitDefaultValue = false)]
        public string ERPQuoteDetailsNumber__c { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ProcessStatus__c: ").Append(ProcessStatus__c).Append("\n");
            sb.Append("  OrderNumber__c: ").Append(OrderNumber__c).Append("\n");
            sb.Append("  OrderDetailsNumber__c: ").Append(OrderDetailsNumber__c).Append("\n");
            sb.Append("  ServiceStartDate__cc: ").Append(ServiceStartDate__cc).Append("\n");
            sb.Append("  ServiceStartDate__c: ").Append(ServiceStartDate__c).Append("\n");
            sb.Append("  ERPQuoteNumber__c: ").Append(ERPQuoteNumber__c).Append("\n");
            sb.Append("  ERPQuoteDetailsNumber__c: ").Append(ERPQuoteDetailsNumber__c).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(Subscription other)
        {
            ...
            return 
                ...
                (
                    this.ProcessStatus__c == other.ProcessStatus__c ||
                    this.ProcessStatus__c != null &&
                    this.ProcessStatus__c.Equals(other.ProcessStatus__c)
                ) &&
                (
                    this.OrderNumber__c == other.OrderNumber__c ||
                    this.OrderNumber__c != null &&
                    this.OrderNumber__c.Equals(other.OrderNumber__c)
                ) &&
                (
                    this.OrderDetailsNumber__c == other.OrderDetailsNumber__c ||
                    this.OrderDetailsNumber__c != null &&
                    this.OrderDetailsNumber__c.Equals(other.OrderDetailsNumber__c)
                ) &&
                (
                    this.ServiceStartDate__cc == other.ServiceStartDate__cc ||
                    this.ServiceStartDate__cc != null &&
                    this.ServiceStartDate__cc.Equals(other.ServiceStartDate__cc)
                ) &&
                (
                    this.ServiceStartDate__c == other.ServiceStartDate__c ||
                    this.ServiceStartDate__c != null &&
                    this.ServiceStartDate__c.Equals(other.ServiceStartDate__c)
                ) &&
                (
                    this.ERPQuoteNumber__c == other.ERPQuoteNumber__c ||
                    this.ERPQuoteNumber__c != null &&
                    this.ERPQuoteNumber__c.Equals(other.ERPQuoteNumber__c)
                ) &&
                (
                    this.ERPQuoteDetailsNumber__c == other.ERPQuoteDetailsNumber__c ||
                    this.ERPQuoteDetailsNumber__c != null &&
                    this.ERPQuoteDetailsNumber__c.Equals(other.ERPQuoteDetailsNumber__c)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ProcessStatus__c != null)
                    hash = hash * 59 + this.ProcessStatus__c.GetHashCode();
                if (this.OrderNumber__c != null)
                    hash = hash * 59 + this.OrderNumber__c.GetHashCode();
                if (this.OrderDetailsNumber__c != null)
                    hash = hash * 59 + this.OrderDetailsNumber__c.GetHashCode();
                if (this.ServiceStartDate__cc != null)
                    hash = hash * 59 + this.ServiceStartDate__cc.GetHashCode();
                if (this.ServiceStartDate__c != null)
                    hash = hash * 59 + this.ServiceStartDate__c.GetHashCode();
                if (this.ERPQuoteNumber__c != null)
                    hash = hash * 59 + this.ERPQuoteNumber__c.GetHashCode();
                if (this.ERPQuoteDetailsNumber__c != null)
                    hash = hash * 59 + this.ERPQuoteDetailsNumber__c.GetHashCode();
                return hash;
            }
        }
