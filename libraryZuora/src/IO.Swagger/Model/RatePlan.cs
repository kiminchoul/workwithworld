...
namespace IO.Swagger.Model
{
    ...
    public partial class RatePlan :  IEquatable<RatePlan>, IValidatableObject
    {
        ...
        public RatePlan(string AmendmentId = null, string AmendmentSubscriptionRatePlanId = null, string AmendmentType = null, string CreatedById = null, DateTime? CreatedDate = null, string Name = null, string ProductRatePlanId = null, string SubscriptionId = null, string UpdatedById = null, DateTime? UpdatedDate = null, string ParentCode__c = null, string ProductCode__c = null, string NeTTSProduct__c = null, string NeTTSUnit__c = null, string BillingFlag__c = null, string RequiredLicense__c = null)
        {
            ...
            this.ParentCode__c = ParentCode__c; //カスタム項目
            this.ProductCode__c = ProductCode__c; //カスタム項目
            this.NeTTSProduct__c = NeTTSProduct__c; //カスタム項目
            this.NeTTSUnit__c = NeTTSUnit__c; //カスタム項目
            this.BillingFlag__c = BillingFlag__c; //カスタム項目
            this.RequiredLicense__c = RequiredLicense__c; //カスタム項目
        }
        ...
        //カスタム項目
        [DataMember(Name = "ParentCode__c", EmitDefaultValue = false)]
        public string ParentCode__c { get; set; }
        [DataMember(Name = "ProductCode__c", EmitDefaultValue = false)]
        public string ProductCode__c { get; set; }
        [DataMember(Name = "NeTTSProduct__c", EmitDefaultValue = false)]
        public string NeTTSProduct__c { get; set; }
        [DataMember(Name = "NeTTSUnit__c", EmitDefaultValue = false)]
        public string NeTTSUnit__c { get; set; }
        [DataMember(Name = "BillingFlag__c", EmitDefaultValue = false)]
        public string BillingFlag__c { get; set; }
        [DataMember(Name = "RequiredLicense__c", EmitDefaultValue = false)]
        public string RequiredLicense__c { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ParentCode__c: ").Append(ParentCode__c).Append("\n");
            sb.Append("  ProductCode__c: ").Append(ProductCode__c).Append("\n");
            sb.Append("  NeTTSProduct__c: ").Append(NeTTSProduct__c).Append("\n");
            sb.Append("  NeTTSUnit__c: ").Append(NeTTSUnit__c).Append("\n");
            sb.Append("  BillingFlag__c: ").Append(BillingFlag__c).Append("\n");
            sb.Append("  RequiredLicense__c: ").Append(RequiredLicense__c).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(RatePlan other)
        {
            ...
            return 
                ...
                (
                    this.ParentCode__c == other.ParentCode__c ||
                    this.ParentCode__c != null &&
                    this.ParentCode__c.Equals(other.ParentCode__c)
                ) &&
                (
                    this.ProductCode__c == other.ProductCode__c ||
                    this.ProductCode__c != null &&
                    this.ProductCode__c.Equals(other.ProductCode__c)
                ) &&
                (
                    this.NeTTSProduct__c == other.NeTTSProduct__c ||
                    this.NeTTSProduct__c != null &&
                    this.NeTTSProduct__c.Equals(other.NeTTSProduct__c)
                ) &&
                (
                    this.NeTTSUnit__c == other.NeTTSUnit__c ||
                    this.NeTTSUnit__c != null &&
                    this.NeTTSUnit__c.Equals(other.NeTTSUnit__c)
                ) &&
                (
                    this.BillingFlag__c == other.BillingFlag__c ||
                    this.BillingFlag__c != null &&
                    this.BillingFlag__c.Equals(other.BillingFlag__c)
                ) &&
                (
                    this.RequiredLicense__c == other.RequiredLicense__c ||
                    this.RequiredLicense__c != null &&
                    this.RequiredLicense__c.Equals(other.RequiredLicense__c)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ParentCode__c != null)
                    hash = hash * 59 + this.ParentCode__c.GetHashCode();
                if (this.ProductCode__c != null)
                    hash = hash * 59 + this.ProductCode__c.GetHashCode();
                if (this.NeTTSProduct__c != null)
                    hash = hash * 59 + this.NeTTSProduct__c.GetHashCode();
                if (this.NeTTSUnit__c != null)
                    hash = hash * 59 + this.NeTTSUnit__c.GetHashCode();
                if (this.BillingFlag__c != null)
                    hash = hash * 59 + this.BillingFlag__c.GetHashCode();
                if (this.RequiredLicense__c != null)
                    hash = hash * 59 + this.RequiredLicense__c.GetHashCode();
                return hash;
            }
        }
