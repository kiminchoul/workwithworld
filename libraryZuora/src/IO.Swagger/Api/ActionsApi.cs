...
namespace IO.Swagger.Api
{
    ...
    public interface IActionsApi : IApiAccessor
    {
        ...
        string ProxyActionPOSTamendString(ProxyActionamendRequest amendRequest);
        string ProxyActionPOSTamendWithHttpInfoString(ProxyActionamendRequest amendRequest);
        /// <summary>
        /// Amend
        /// </summary>
        /// <remarks>
        ...
        //★ ProxyActioncreateResponse ProxyActionPOSTcreate(ZObjectPayBank createRequest);
        ProxyActioncreateResponse ProxyActionPOSTcreate(ProxyActioncreateRequestBank createRequest);
        /// <summary>
        /// Create
        /// </summary>
        /// <remarks>
        ...
        //★ ApiResponse<ProxyActioncreateResponse> ProxyActionPOSTcreateWithHttpInfo(ZObjectPayBank createRequest);
        ApiResponse<ProxyActioncreateResponse> ProxyActionPOSTcreateWithHttpInfo (ProxyActioncreateRequestBank createRequest);        
        /// <summary>
        /// Delete
        /// </summary>
        /// <remarks>
        ...
        string  ProxyActionPOSTquery(ProxyActionqueryRequest queryRequest);
        string ProxyActionPOSTqueryServiceRateID(ProxyActionqueryRequest queryRequest);
        ...
        string ProxyActionPOSTqueryWithHttpInfo(ProxyActionqueryRequest queryRequest);
        string ProxyActionPOSTqueryWithHttpInfoServiceRateID(ProxyActionqueryRequest queryRequest);
        /// <summary>
        /// QueryMore
        /// </summary>
        /// <remarks>
        ...
        string ProxyActionPOSTsubscribe(ProxyActionsubscribeRequest subscribeRequest);
        ...
        string ProxyActionPOSTsubscribeWithHttpInfo(ProxyActionsubscribeRequest subscribeRequest);
        /// <summary>
        /// Update
        /// </summary>
        /// <remarks>
        ...
        ProxyActionupdateResponse ProxyActionPOSTupdate(ProxyActionupdateRequestDefPay updateRequest);
        string ProxyActionPOSTupdateString(ProxyActionupdateRequestDefPay updateRequest);
        /// <summary>
        /// Update
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<ProxyActionupdateResponse> ProxyActionPOSTupdateWithHttpInfo(ProxyActionupdateRequestDefPay updateRequest);
        string ProxyActionPOSTupdateWithHttpInfoString(ProxyActionupdateRequestDefPay updateRequest);
    ...
    public partial class ActionsApi : IActionsApi
    {
        ...
        public string ProxyActionPOSTamendString(ProxyActionamendRequest amendRequest)
        {
            string localVarResponse = ProxyActionPOSTamendWithHttpInfoString(amendRequest);
            return localVarResponse;
        }
        public string ProxyActionPOSTamendWithHttpInfoString(ProxyActionamendRequest amendRequest)
        {
        ...
        //public ProxyActioncreateResponse ProxyActionPOSTcreate(ZObjectPayBank createRequest)
        public ProxyActioncreateResponse ProxyActionPOSTcreate(ProxyActioncreateRequestBank createRequest)        
        {
        ...
        //★public ApiResponse<ProxyActioncreateResponse> ProxyActionPOSTcreateWithHttpInfo(ZObjectPayBank createRequest)
        public ApiResponse< ProxyActioncreateResponse > ProxyActionPOSTcreateWithHttpInfo (ProxyActioncreateRequestBank createRequest)
        {
            ...
            //★ Cannot deserialize the current JSON array (e.g. [1,2,3]) into type 'IO.Swagger.Model.ProxyActioncreateResponse'
            //★ because the type requires a JSON object(e.g. { "name":"value"}) to deserialize correctly.
            //★ [{"Success":true,"Id":"2c92c0f95c2063fb015c34a23b9710a7"}] ->{"Success":true,"Id":"2c92c0f95c2063fb015c34a23b9710a7"}
            string editContent = localVarResponse.Content;            
            editContent = editContent.Replace("[{", "{");
            editContent = editContent.Replace("}]", "}");
            localVarResponse.Content = editContent;
        ...
        public string  ProxyActionPOSTquery(ProxyActionqueryRequest queryRequest)
        {
             string localVarResponse = ProxyActionPOSTqueryWithHttpInfo(queryRequest);
             return localVarResponse;
        }
        ...
        public string ProxyActionPOSTqueryWithHttpInfo(ProxyActionqueryRequest queryRequest)
        {
            ...
            /** ★ just to Pass out with  selected ID
            ...
            */
            ...
            //★ because the type requires a JSON object(e.g. { "name":"value"}) to deserialize correctly.
            //★ [{"Success":true,"Id":"2c92c0f95c2063fb015c34a23b9710a7"}] ->{"Success":true,"Id":"2c92c0f95c2063fb015c34a23b9710a7"}
            //paymentMethodのbank用のid取得用として改修したが、ほかのオブジェクトのID取得にも使用する。
            if (localVarResponse.ContentLength == 76)
            {
                string selectePaydBankID = localVarResponse.Content;
                selectePaydBankID = selectePaydBankID.Replace(@"\", string.Empty);
                selectePaydBankID = selectePaydBankID.Substring(19, 32);
                return selectePaydBankID;
            }
            //　ProductRatePlanより品目コード取得用 + RequiredLicense__c、BillingFlag__c、ChargeModel
            else if (localVarResponse.ContentLength > 76)
            {
                string selecteProductCode = localVarResponse.Content;
                selecteProductCode = selecteProductCode.Replace(@"\", string.Empty);   //これは効かないような

                //ProductRatePlanより品目コード取得用 + RequiredLicense__c、BillingFlag__c、ChargeModel
                /** //int foundIndexHead = selecteProductCode.IndexOf("ProductCode__c");
                //int foundIndexTail = selecteProductCode.IndexOf("Id");
                //selecteProductCode = selecteProductCode.Substring(foundIndexHead + 17, foundIndexTail - 34);
                */
                int foundIndexHead = 0;
                int foundIndexHead0 = selecteProductCode.IndexOf("ProductCode__c");
                int foundIndexHead1 = selecteProductCode.IndexOf("RequiredLicense__c");
                int foundIndexHead2 = selecteProductCode.IndexOf("BillingFlag__c");
                int foundIndexHead3 = selecteProductCode.IndexOf("ChargeModel");
                int foundIndexHead4 = selecteProductCode.IndexOf("PlanQuantity__c");
                int foundIndexHead5 = selecteProductCode.IndexOf("ChargeType");

                if (foundIndexHead0 > 0)
                {   //ProductCode__c
                    foundIndexHead = foundIndexHead0;
                    int foundIndexTail = selecteProductCode.IndexOf("Id");
                    selecteProductCode = selecteProductCode.Substring(foundIndexHead + 17, foundIndexTail - 34);
                }
                else if (foundIndexHead1 > 0)
                {   //RequiredLicense__c
                    foundIndexHead = foundIndexHead1;
                    int foundIndexTail = selecteProductCode.IndexOf("Id");
                    selecteProductCode = selecteProductCode.Substring(foundIndexHead + 21, foundIndexTail - 38);
                }
                else if (foundIndexHead2 > 0)
                {   //BillingFlag__c
                    foundIndexHead = foundIndexHead2;
                    int foundIndexTail = selecteProductCode.IndexOf("Id");
                    selecteProductCode = selecteProductCode.Substring(foundIndexHead + 17, foundIndexTail - 34);
                }
                else if (foundIndexHead3 > 0)
                {   //ChargeModel
                    foundIndexHead = foundIndexHead3;
                    int foundIndexTail = selecteProductCode.IndexOf("Id");
                    selecteProductCode = selecteProductCode.Substring(foundIndexHead + 14, foundIndexTail - 31);
                }
                else if (foundIndexHead4 > 0)
                {   //PlanQuantity__c
                    foundIndexHead = foundIndexHead4;
                    int foundIndexTail = selecteProductCode.IndexOf("Id");
                    selecteProductCode = selecteProductCode.Substring(foundIndexHead + 18, foundIndexTail - 35);
                }
                else if (foundIndexHead5 > 0)
                {   //ChargeType
                    foundIndexHead = foundIndexHead5;
                    int foundIndexTail = selecteProductCode.IndexOf("Id");
                    selecteProductCode = selecteProductCode.Substring(foundIndexHead + 13, foundIndexTail - 30);
                }

                //selecteProductCode = selecteProductCode.Replace(@"""},{", ",");
                //selecteProductCode = selecteProductCode.Replace(@"""Id"":""", string.Empty);
                return selecteProductCode;
            }
            else
            {
                //subscription作成のaccountKeyがaccountIdの場合、検索結果がZEROになってエラーになるので       
                string selectePaydBankID = null;
                return selectePaydBankID;
            }
        }

        public string ProxyActionPOSTqueryServiceRateID(ProxyActionqueryRequest queryRequest)
        {
            string localVarResponse = ProxyActionPOSTqueryWithHttpInfoServiceRateID(queryRequest);
            return localVarResponse;
        }

        public string ProxyActionPOSTqueryWithHttpInfoServiceRateID(ProxyActionqueryRequest queryRequest)
        {
            // verify the required parameter 'queryRequest' is set
            if (queryRequest == null)
                throw new ApiException(400, "Missing required parameter 'queryRequest' when calling ActionsApi->ProxyActionPOSTquery");
            ...
            /** ★ just Passout with selected ID
            return new ApiResponse<ProxyActionqueryResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (ProxyActionqueryResponse) Configuration.ApiClient.Deserialize(localVarResponse, typeof(ProxyActionqueryResponse)));
            */

            /**  localVarResponse.Content 中身
            "{\"records\":[
                {\"Id\":\"2c92c0f95cee23f4015d0b4f5fe22fca\"},{\"Id\":\"2c92c0f85cee08f6015d0b53ea251b04\"}
            ],\"size\":2,\"done\":true}"
            */
            ...
            //#2.[ ]の位置を特定して、その間を切り取る
            //#3. Replace("{Id:", string.Empty);
            //#4. Replace("},{", ",");
            
            */
            string selRatePlanID = localVarResponse.Content;
            selRatePlanID = selRatePlanID.Replace(@"\", string.Empty);   //これは効かないような
            int foundIndexHead = selRatePlanID.IndexOf("[{");
            int foundIndexTail = selRatePlanID.IndexOf("}]");
            if (foundIndexHead < 0)
            {
                selRatePlanID = null;
            }
            ...
            { 
                selRatePlanID = selRatePlanID.Substring(foundIndexHead + 8, foundIndexTail - 20);
                selRatePlanID = selRatePlanID.Replace(@"""},{", ",");
                selRatePlanID = selRatePlanID.Replace(@"""Id"":""", string.Empty);
            }

            return selRatePlanID;
        }
        /// <summary>
        /// Query The query call sends a query expression by specifying the object to query, the fields to retrieve from that object, and any filters to determine whether a given object should be queried.   You can use [Zuora Object Query Language](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/M_Zuora_Object_Query_Language) construct those queries, passing them through the &#x60;queryString&#x60;.   Once the call is made, the API executes the query against the specified object and returns a query response object to your application. Your application can then iterate through rows in the query response to retrieve information.  ## Limitations   This call has the following limitations:  * All keywords must be in lower case. * The number of records returned is limited to 2000 records 
        /// </summary>
        ...
        public string ProxyActionPOSTsubscribe(ProxyActionsubscribeRequest subscribeRequest)
        {
             string localVarResponse = ProxyActionPOSTsubscribeWithHttpInfo(subscribeRequest);
             return localVarResponse;
        }
        ...
        public string ProxyActionPOSTsubscribeWithHttpInfo(ProxyActionsubscribeRequest subscribeRequest)
        {
            ...
            // 20170720  Cannot deserialize the current JSON array (e.g. [1,2,3]) into type 'IO.Swagger.Model.ProxyActioncreateResponse'
            //★ because the type requires a JSON object(e.g. { "name":"value"}) to deserialize correctly.
            //★ [{"Success":true,"Id":"2c92c0f95c2063fb015c34a23b9710a7"}] ->{"Success":true,"Id":"2c92c0f95c2063fb015c34a23b9710a7"}
            string editContent = localVarResponse.Content;
            editContent = editContent.Replace("[{", "{");
        ...
        public ProxyActionupdateResponse ProxyActionPOSTupdate(ProxyActionupdateRequestDefPay updateRequest)            
        {
             ApiResponse<ProxyActionupdateResponse> localVarResponse = ProxyActionPOSTupdateWithHttpInfo(updateRequest);
             return localVarResponse.Data;
        }
        public string ProxyActionPOSTupdateString(ProxyActionupdateRequestDefPay updateRequest)
        {
            string localVarResponse = ProxyActionPOSTupdateWithHttpInfoString(updateRequest);
            return localVarResponse;
        }
        public string ProxyActionPOSTupdateWithHttpInfoString(ProxyActionupdateRequestDefPay updateRequest)
        {
        ...
        public ApiResponse<ProxyActionupdateResponse> ProxyActionPOSTupdateWithHttpInfo(ProxyActionupdateRequestDefPay updateRequest)
        {
            // verify the required parameter 'updateRequest' is set
            if (updateRequest == null)
                throw new ApiException(400, "Missing required parameter 'updateRequest' when calling ActionsApi->ProxyActionPOSTupdate");
