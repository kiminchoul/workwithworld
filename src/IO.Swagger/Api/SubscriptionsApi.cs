...
namespace IO.Swagger.Api
{
    ...
    public interface ISubscriptionsApi : IApiAccessor
    {
        ...
        string[] GETOneSubscription(string subscriptionKey, string chargeDetail = null);
        /// <summary>
        /// Get subscriptions by key
        /// </summary>
        /// <remarks>
        ...
        string[] GETOneSubscriptionWithHttpInfo(string subscriptionKey, string chargeDetail = null);

        string ToCSV(DataTable table, string delimator);
        /// <summary>
        ...
        string POSTSubscriptionCancellationString(string subscriptionKey, POSTSubscriptionCancellationType request, string zuoraVersion = null);
        string POSTSubscriptionCancellationWithHttpInfoString (string subscriptionKey, POSTSubscriptionCancellationType request, string zuoraVersion = null);
        ...
        string PUTSubscriptionString(string subscriptionKey, PUTSubscriptionType request, string zuoraVersion = null);
        string PUTSubscriptionStringWithHttpInfo(string subscriptionKey, PUTSubscriptionType request, string zuoraVersion = null);
        /// <summary>
        /// Update subscription
        /// </summary>
        /// <remarks>
        ...
        //sync
        POSTSubscriptionResponseType POSTSubscriptionSync(POSTSubscriptionType request, string zuoraVersion = null);
        /// <summary>
        /// Create subscription
        /// </summary>
        /// <remarks>
        ...
        //sync
        ApiResponse<POSTSubscriptionResponseType> POSTSubscriptionSyncWithHttpInfo(POSTSubscriptionType request, string zuoraVersion = null);
        /// <summary>
        /// Cancel subscription
        /// </summary>
        /// <remarks>
    ...
    public partial class SubscriptionsApi : ISubscriptionsApi
    {
        ...
        public string[] GETOneSubscription(string subscriptionKey, string chargeDetail = null)
        {
            ...
            return  GETOneSubscriptionWithHttpInfo(subscriptionKey, chargeDetail);            
        }
        ...
        /// <param name="chargeDetail"> The segmented rate plan charges. When an amendment results in a change to a charge, Zuora creates a segmented rate plan charge. Use this field to track segment charges.  Possible values are:   * __last-segment__: (Default) The last rate plan charge on the subscription. The last rate plan charge is the last one in the order of time on the subscription rather than the most recent changed charge on the subscription.  * __current-segment__: The segmented charge that is active on today’s date (effectiveStartDate &lt;&#x3D; today’s date &lt; effectiveEndDate).    * __all-segments__: All the segmented charges.   * __specific-segment&amp;as-of-date&#x3D;date__: The segmented charge that is active on a date you specified (effectiveStartDate &lt;&#x3D; specific date &lt; effectiveEndDate). The format of the date is yyyy-mm-dd.  (optional)</param>
        /// <returns>ApiResponse of GETSubscriptionTypeWithSuccess</returns>
        //★■ makeSubscriptionCSV  //public ApiResponse< GETSubscriptionTypeWithSuccess > GETOneSubscriptionWithHttpInfo (string subscriptionKey, string chargeDetail = null)
        public string[] GETOneSubscriptionWithHttpInfo(string subscriptionKey, string chargeDetail = null)
        {
            ...
            //★JSON -> CSV test
            XmlNode xml = JsonConvert.DeserializeXmlNode("{records:{record:" + localVarResponse.Content + "}}");
            ...
            /**
            var csv0 = ToCSV(dataSet.Tables[0], ",");
            var csv1 = ToCSV(dataSet.Tables[1], ",");
            var csv2 = ToCSV(dataSet.Tables[2], ",");
            var csv3 = ToCSV(dataSet.Tables[3], ",");
            */
            //string[] csvSub = new string[] { "sub", "ratePlan", "charge"};
            string[] csvSub = new string[dataSet.Tables.Count] ;            
            for (int i = 0; i < dataSet.Tables.Count; i++)
            {                
                csvSub[i] = ToCSV(dataSet.Tables[i], ",");
            }
            return csvSub;
        ...
        public string ToCSV(DataTable table, string delimator)
        {
            ...
            foreach (DataRow row in table.Rows)
            {
                for (int i = 0; i < table.Columns.Count; i++)
                {
                    ...
                    string kanmaEscape = row[i].ToString();
                    kanmaEscape = kanmaEscape.Replace(",", "、");
                    result.Append(kanmaEscape);
        ...
        //sync
        public POSTSubscriptionResponseType POSTSubscriptionSync(POSTSubscriptionType request, string zuoraVersion = null)
        {
            //★★ READ csv file to create Subscription 
            //Async
            //ApiResponse<POSTSubscriptionResponseType> localVarResponse = await POSTSubscriptionAsyncWithHttpInfo(request, zuoraVersion);
            //sync
            ApiResponse<POSTSubscriptionResponseType> localVarResponse = POSTSubscriptionSyncWithHttpInfo(request, zuoraVersion);
            return localVarResponse.Data;
        ...
        //sync
        public ApiResponse<POSTSubscriptionResponseType> POSTSubscriptionSyncWithHttpInfo(POSTSubscriptionType request, string zuoraVersion = null)
        {
            // verify the required parameter 'request' is set
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling SubscriptionsApi->POSTSubscription");
        ...
        public string POSTSubscriptionCancellationString(string subscriptionKey, POSTSubscriptionCancellationType request, string zuoraVersion = null)
        {
            string localVarResponse = POSTSubscriptionCancellationWithHttpInfoString(subscriptionKey, request, zuoraVersion);
            return localVarResponse;
        }
        public string POSTSubscriptionCancellationWithHttpInfoString(string subscriptionKey, POSTSubscriptionCancellationType request, string zuoraVersion = null)
        {
            // verify the required parameter 'subscriptionKey' is set
            if (subscriptionKey == null)
        ...
        public string PUTSubscriptionString(string subscriptionKey, PUTSubscriptionType request, string zuoraVersion = null)
        {
            string localVarResponse = PUTSubscriptionStringWithHttpInfo(subscriptionKey, request, zuoraVersion);
            return localVarResponse;
        }
        public string PUTSubscriptionStringWithHttpInfo(string subscriptionKey, PUTSubscriptionType request, string zuoraVersion = null)
        {
            // verify the required parameter 'subscriptionKey' is set
            if (subscriptionKey == null)
