...
namespace IO.Swagger.Model
{
    ...
    public partial class PUTSubscriptionType :  IEquatable<PUTSubscriptionType>, IValidatableObject
    {
        ...
        public PUTSubscriptionType(string CpqBundleJsonIdQT = null, string OpportunityCloseDateQT = null, string OpportunityNameQT = null, string QuoteBusinessTypeQT = null, string QuoteNumberQT = null, string QuoteTypeQT = null, List<PUTSrpAddType> Add = null, bool? ApplyCreditBalance = null, bool? AutoRenew = null, long? CurrentTerm = null, string CurrentTermPeriodType = null, string CustomFieldC = null, bool? IncludeExistingDraftInvoiceItems = null, bool? Invoice = null, bool? InvoiceCollect = null, bool? InvoiceSeparately = null, DateTime? InvoiceTargetDate = null, string Notes = null, bool? Preview = null, string PreviewType = null, List<PUTSrpRemoveType> Remove = null, string RenewalSetting = null, long? RenewalTerm = null, string RenewalTermPeriodType = null, DateTime? TermStartDate = null, string TermType = null, List<PUTSrpUpdateType> Update = null, string NeTTSSyncFlag__c = null, string ServiceStartDate__c = null, string AutoRenewVersion__c = null, string ParentSubscriptionNumber__c = null, string invoiceOwnerAccountId = null, string LicenseOfferDate__c = null, string TrialOfferDate__c = null, string OfferDate__c = null, string BillingStartDate__c = null)
        {
            ...
            this.Update = Update;
            this.NeTTSSyncFlag__c = NeTTSSyncFlag__c; //カスタム項目
            this.ServiceStartDate__c = ServiceStartDate__c; //カスタム項目
            this.AutoRenewVersion__c = AutoRenewVersion__c; //カスタム項目
            this.ParentSubscriptionNumber__c = ParentSubscriptionNumber__c; //カスタム項目
            this.invoiceOwnerAccountId = invoiceOwnerAccountId; //請求先
            this.LicenseOfferDate__c = LicenseOfferDate__c; //カスタム項目
            this.TrialOfferDate__c = TrialOfferDate__c; //カスタム項目
            this.OfferDate__c = OfferDate__c; //カスタム項目
            this.BillingStartDate__c = BillingStartDate__c; //カスタム項目
        }
        ...
        [DataMember(Name = "NeTTSSyncFlag__c", EmitDefaultValue = false)]
        public string NeTTSSyncFlag__c { get; set; }
        [DataMember(Name = "ServiceStartDate__c", EmitDefaultValue = false)]
        public string ServiceStartDate__c { get; set; }
        [DataMember(Name = "AutoRenewVersion__c", EmitDefaultValue = false)]
        public string AutoRenewVersion__c { get; set; }
        [DataMember(Name = "ParentSubscriptionNumber__c", EmitDefaultValue = false)]
        public string ParentSubscriptionNumber__c { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NeTTSSyncFlag__c: ").Append(NeTTSSyncFlag__c).Append("\n");
            sb.Append("  ServiceStartDate__c: ").Append(ServiceStartDate__c).Append("\n");
            sb.Append("  AutoRenewVersion__c: ").Append(AutoRenewVersion__c).Append("\n");
            sb.Append("  ParentSubscriptionNumber__c: ").Append(ParentSubscriptionNumber__c).Append("\n");
        ...
        public bool Equals(PUTSubscriptionType other)
        {
            ...
            return 
                ...
                (
                    this.NeTTSSyncFlag__c == other.NeTTSSyncFlag__c ||
                    this.NeTTSSyncFlag__c != null &&
                    this.NeTTSSyncFlag__c.Equals(other.NeTTSSyncFlag__c)
                ) &&
                (
                ...
                (
                    this.AutoRenewVersion__c == other.AutoRenewVersion__c ||
                    this.AutoRenewVersion__c != null &&
                    this.AutoRenewVersion__c.Equals(other.AutoRenewVersion__c)
                ) &&
                (
                    this.ParentSubscriptionNumber__c == other.ParentSubscriptionNumber__c ||
                    this.ParentSubscriptionNumber__c != null &&
                    this.ParentSubscriptionNumber__c.Equals(other.ParentSubscriptionNumber__c)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.NeTTSSyncFlag__c != null)
                    hash = hash * 59 + this.NeTTSSyncFlag__c.GetHashCode();
                if (this.ServiceStartDate__c != null)
                    hash = hash * 59 + this.ServiceStartDate__c.GetHashCode();
                if (this.AutoRenewVersion__c != null)
                    hash = hash * 59 + this.AutoRenewVersion__c.GetHashCode();
                if (this.ParentSubscriptionNumber__c != null)
                    hash = hash * 59 + this.ParentSubscriptionNumber__c.GetHashCode();
